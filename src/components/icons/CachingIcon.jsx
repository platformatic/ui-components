    ...
    case SMALL:
      icon = (
        ...
        >
          ...
          <path d='M3.125 8.00115V6.06201H3.65151V6.81949H4.34848V6.06201H4.87499V8.00115H4.34848V7.24367H3.65151V8.00115H3.125Z' fill='white' />
          <path d='M5.07196 6.4862V6.06201H6.75756V6.4862H6.17423V8.00115H5.65529V6.4862H5.07196Z' fill='white' />
          <path d='M6.90269 6.4862V6.06201H8.58829V6.4862H8.00496L7.99998 7.49932L7.48602 8.00115V6.4862H6.90269Z' fill='white' />
    ...
    case MEDIUM:
      icon = (
        ...
        >
          ...
          <path d='M4.6875 12.0017V9.09302H5.47727V10.2292H6.52272V9.09302H7.31249V12.0017H6.52272V10.8655H5.47727V12.0017H4.6875Z' fill='white' />
          <path d='M7.60795 9.7293V9.09302H10.1363V9.7293H9.26135V12.0017H8.48294V9.7293H7.60795Z' fill='white' />
          <path d='M10.354 9.7293V9.09302H12.8824V9.7293H12.0074L12 11.249L11.229 12.0017V9.7293H10.354Z' fill='white' />
          <path d='M13.1797 11.0146V9.09302H14.4353C14.6512 9.09302 14.8402 9.13563 15.0021 9.22084C15.164 9.30606 15.29 9.42583 15.3799 9.58017C15.4699 9.7345 15.5149 9.91488 15.5149 10.1213C15.5149 10.3296 15.4685 10.51 15.3757 10.6624C15.2838 10.8149 15.1546 10.9323 14.9879 11.0146C14.8222 11.097 14.6285 11.1382 14.4069 11.1382H13.6569V10.5246H14.2478C14.3406 10.5246 14.4197 10.5086 14.4851 10.4764C14.5513 10.4432 14.602 10.3963 14.637 10.3358C14.673 10.2752 14.691 10.2037 14.691 10.1213C14.691 10.038 14.673 9.96696 14.637 9.90825C14.602 9.8486 14.5513 9.80315 14.4851 9.77191C14.4197 9.73971 14.3406 9.72362 14.2478 9.72362H13.9694V11.0146H13.1797Z' fill='white' />
        </svg>
      )
      break
    case LARGE:
