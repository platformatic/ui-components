    ...
    case SMALL:
      icon = (
        <svg
          ...
          className={className}
        >
          <path d='M8 5L8 9.5M8 9.5L9.5 8.16667M8 9.5L6.5 8.16667' stroke='white' stroke-linecap='round' stroke-linejoin='round' />
    ...
    case MEDIUM:
      icon = (
        <svg
          ...
          className={className}
        >
          <path d='M12 7.5L12 14.25M12 14.25L14.25 12.25M12 14.25L9.75 12.25' stroke='white' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round' />
          ...
          <path d='M8.99985 19.1094H15.5999V20.8513H8.99985V19.1094Z' stroke='white' stroke-width='1.5' stroke-linejoin='round' />
        </svg>
      )
      break
    case LARGE:
      icon = (
        <svg
          ...
          className={className}
        >
          <path d='M20 12.5L20 23.75M20 23.75L23.75 20.4167M20 23.75L16.25 20.4167' stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' />
          ...
          <path d='M14.9998 31.8516H25.9998V34.7548H14.9998V31.8516Z' stroke='white' stroke-width='2' stroke-linejoin='round' />
        </svg>
      )
      break
